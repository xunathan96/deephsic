...
dataset_to_testsize["hdgm4"]="500"
dataset_to_testsize["hdgm8"]="500"
dataset_to_testsize["hdgm10"]="500"
dataset_to_testsize["hdgm20"]="500"
dataset_to_testsize["hdgm30"]="500"
dataset_to_testsize["hdgm40"]="500"
dataset_to_testsize["hdgm50"]="500"
...
# source eval_type1.sh $run "hsic hsic-tied" "$datasets"

# source train.sh $run "c2st" "$datasets"
# source eval_type1.sh $run "c2st-s c2st-l" "$datasets"

# source train.sh $run "mmd" "$datasets"
# source eval_type1.sh $run "mmd" "$datasets"
