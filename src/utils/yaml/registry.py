...
yamlRegistry.register(yaml_tag=u'!generator.HDGM',          nodetype=YamlNodeType.MAPPING).map_to(data.toy.HDGMGenerator)
...
yamlRegistry.register(yaml_tag=u'!generator.Sinusoid',      nodetype=YamlNodeType.MAPPING).map_to(data.toy.SinusoidGenerator)
yamlRegistry.register(yaml_tag=u'!generator.ISA',           nodetype=YamlNodeType.MAPPING).map_to(data.toy.ISAGenerator)
